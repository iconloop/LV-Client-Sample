...
public class RangeProof {
    ...
    public int verify(EC.Point commit, BulletProofTuple proof, BigInteger rangeA, BigInteger rangeB) {
        ...
        EC.Point aG = _bp.getG().scalarMul(_curve.scalar(rangeA));
        ...
        EC.Point bG = _bp.getG().scalarMul(_curve.scalar(rangeB)); //bG
